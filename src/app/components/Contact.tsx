...
export function Contact() {
  ...
  return (
    <section
      id="contact"
      className="min-h-screen py-20 px-6 bg-slate-50 overflow-hidden relative"
      ref={ref}
    >
          ...
          <div className="space-y-8">
            ...
            >
              {contactInfo.map((info) => (
                ...
                >
                  <div
                    className={`p-4 rounded-full ${info.color} group-hover:scale-110 transition-transform duration-300`}
                  >
                    <info.icon size={24} />
                  </div>
                  <div>
                  ...
                  <ArrowRight
                    className="ml-auto text-slate-300 group-hover:text-blue-600 group-hover:translate-x-1 transition-all"
                    size={20}
                  />
                </motion.a>
              ))}
